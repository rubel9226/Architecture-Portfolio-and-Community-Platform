...
export const Navbar: React.FC<NavbarProps> = ({session}) => {
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-40 w-full h-20 flex items-center bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b transition-all duration-300 border-transparent select-none`}>
