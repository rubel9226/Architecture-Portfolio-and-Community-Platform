...
export default function MasonryCard({ id, image, category, author, location }: MasonryCardProps) {
  return (
    <Link href={`/projects/${id}`} className="group relative rounded-2xl overflow-hidden aspect-square border border-slate-100 shadow-sm">
