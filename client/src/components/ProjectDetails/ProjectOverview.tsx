  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-slate-600 font-light leading-relaxed text-lg">{data.description}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-100">
        ...
        <div>
          ...
          <p className="text-slate-600 text-sm leading-relaxed">{data.concept}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-slate-100">
        <div>
          ...
          <p className="text-slate-600 text-sm leading-relaxed">{data.challenges}</p>
        </div>
        <div>
          <h4 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-2">Applied Engineering</h4>
          <p className="text-slate-600 text-sm leading-relaxed">{data.solutions}</p>
        </div>
      </div>
    </motion.div>
  );
